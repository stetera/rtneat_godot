...
func spawn_next_generation(total_avg_adj_fitness: float) -> void:
	...
	for species:Species in alive_ga_species.values():
		...
		#var share_of_total_fitness = species_adj_fitness / total_adj_avg_fitness
		#var allowed_population_size = int(clamp(shared_population_size * share_of_total_fitness, 0, Params.maximum_population_size))
		...
		#print("MAX ALLOWED POP IS: ", Params.maximum_population_size)
		#print("ALLOWED POP IS: ", allowed_population_size)kkkkkkkkkkkkkkkkkkk
