...
func _ready() -> void:
	...
	"""
	UiController.start_hotbar($CanvasLayer)
	UiController.pause.connect(set_paused)
	UiController.play.connect(set_play)
...
func set_play() -> void:
	GaController.set_pause_state(false)
...
func _physics_process(delta: float) -> void:
	...
	if cycle_time > TIME_STEP:
		...
		UiController.refresh_species(SpeciesController.alive_ga_species.values())
