...
var neuron_id: int
# See Enums.NEURON_TYPE enum how the id is mapped
var neuron_type: int
...
func copy() -> Neuron:
	...
	"""
	var new_copy = get_script().new(neuron_id,
								neuron_type,
								position,
								activation_curve,
								loop_back)
...
func print_rep() -> void:
	print("nid:", neuron_id ," type: ", neuron_type, "id: ", neuron_id, "_ac:" ,activation_curve)
